  ...
  return (
    <main>
      <section className="mx-auto max-w-5xl px-6 pt-16 pb-12 text-center">
        <Reveal delay={0}><p className="hero-eyebrow text-[var(--brand-green)]">ABOUT</p></Reveal>
        <Reveal delay={120}><h1 className="hero-title mt-6">
          BUILT BY PEOPLE
          <br />
        ...
        <Reveal delay={240}><p className="mx-auto mt-6 max-w-3xl text-sm text-foreground/85">
        ...
        <Reveal delay={340}><p className="mx-auto mt-3 max-w-3xl text-xs text-muted-foreground">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Reveal><div className="rounded-2xl border border-white/10 bg-[var(--brand-navy-card)] p-6">
          ...
          <Reveal delay={120}><div className="rounded-2xl border border-white/10 bg-[var(--brand-navy-card)] p-6">
          ...
          <Reveal delay={240}><div className="rounded-2xl border border-white/10 bg-[var(--brand-navy-card)] p-6">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
          ...
          <Reveal delay={120}><img src={openSource} alt="Open source code" className="aspect-[4/3] w-full object-contain" /></Reveal>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
          <Reveal><img src={mockupAppPage1} alt="Chimera Wallet phone mockups" className="aspect-[5/4] w-full object-contain" /></Reveal>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 text-center">
        <Reveal><h2 className="display text-2xl">WHAT WE</h2></Reveal>
        <Reveal delay={120}><p className="display text-3xl md:text-5xl">STAND FOR.</p></Reveal>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {[
            ...
            <Reveal key={t} delay={i * 120}><div className="rounded-2xl border border-white/10 bg-[var(--brand-navy-card)] p-6">
              <h3 className="display text-xl text-[var(--brand-green)]">{t}</h3>
              <p className="mt-3 text-sm text-foreground/85">{b}</p>
            </div></Reveal>
          ))}
        </div>
        <Reveal><div className="mt-10 text-center">
