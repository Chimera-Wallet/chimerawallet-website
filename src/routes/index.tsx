      ...
      >
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
          <div className="relative w-full aspect-[830/663] rounded-2xl overflow-hidden">
            ...
            <div className="absolute left-1/2 top-1/2 w-[58%] -translate-x-1/2 -translate-y-1/2 aspect-[1.586/1] rounded-2xl overflow-hidden backdrop-blur-2xl bg-white/[0.02] border border-white/20 shadow-[0_20px_60px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.45),inset_0_-1px_0_rgba(255,255,255,0.08)] ring-1 ring-white/10">
              <img src={scCard.url} alt="Chimera card" className="relative h-full w-full object-cover opacity-75 saturate-200 brightness-125" />
