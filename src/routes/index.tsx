      ...
      >
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 md:grid-cols-2">
          <div className="relative w-full aspect-[830/663] rounded-2xl overflow-hidden">
            ...
            <div className="absolute left-1/2 top-1/2 w-[58%] -translate-x-1/2 -translate-y-1/2 aspect-[1.586/1] rounded-2xl overflow-hidden backdrop-blur-xl bg-white/10 border border-white/20 shadow-[0_20px_60px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(255,255,255,0.08)] ring-1 ring-white/10">
              <div className="absolute inset-0 bg-gradient-to-br from-white/25 via-white/5 to-transparent pointer-events-none" />
              <div className="absolute -top-1/2 -left-1/4 w-[150%] h-[120%] bg-gradient-to-br from-white/30 via-transparent to-transparent rotate-12 pointer-events-none" />
              <img src={scCard.url} alt="Chimera card" className="relative h-full w-full object-cover mix-blend-screen opacity-90" />
            </div>
