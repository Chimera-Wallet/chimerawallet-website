    ...
    <main>
      <section className="relative mx-auto max-w-7xl px-6 pt-16 pb-10 overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10">
          ...
          <img src={heroCoin5} alt="" className="absolute right-[2%] bottom-[42%] sm:right-[18%] sm:bottom-[30%] md:right-[12%] md:bottom-[24%] w-12 sm:w-16 md:w-24 lg:w-32 animate-[float_8.5s_ease-in-out_infinite_-3s] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]" />
        </div>
