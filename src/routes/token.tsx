...
function TokenPage() {
  return (
    <main>
      <section className="relative mx-auto max-w-7xl px-6 pt-16 pb-10 overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10">
          ...
          <img src={heroCoin3} alt="" className="absolute right-[-12%] top-[42%] w-14 sm:w-24 md:w-36 lg:w-44 animate-[float_9s_ease-in-out_infinite_-4s] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]" />
          <img src={heroCoin4} alt="" className="absolute left-[6%] bottom-[42%] sm:bottom-[32%] md:bottom-[24%] w-12 sm:w-16 md:w-24 lg:w-28 animate-[float_7.5s_ease-in-out_infinite_-1s] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]" />
          <img src={heroCoin5} alt="" className="absolute right-[2%] bottom-[40%] sm:right-[18%] sm:bottom-[28%] md:right-[12%] md:bottom-[22%] w-12 sm:w-16 md:w-24 lg:w-32 animate-[float_8.5s_ease-in-out_infinite_-3s] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]" />
        </div>
