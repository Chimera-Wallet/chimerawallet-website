    ...
    <main>
      <section className="relative mx-auto max-w-7xl px-6 pt-16 pb-10">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10">
          ...
          <img src={heroCoin5} alt="" className="absolute right-[18%] bottom-[30%] sm:bottom-[24%] md:bottom-[18%] w-12 sm:w-16 md:w-24 lg:w-32 animate-[float_8.5s_ease-in-out_infinite_-3s] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)]" />
        </div>
